package net.teujaem.spProxyData.player.entity;

import jakarta.persistence.*;
import net.teujaem.spProxyData.player.converter.ItemStackBase64;
import net.teujaem.spProxyData.player.converter.MapJsonConverter;
